...
\label{sec:orgd322b2c}

\begin{table}[htbp]
\caption{\label{tab:org0d5a230}
...
The initial dephasing step in the measurement model (Fig. \ref{fig:orgf1b305a}) occurs due to the \hyperref[sec:org0b738db]{photon decay} effect.
