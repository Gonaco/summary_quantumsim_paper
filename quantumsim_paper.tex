...
\label{sec:orga915d91}

\begin{table}[htbp]
\caption{\label{tab:org936fab6}
...
The initial dephasing step in the measurement model (Fig. \ref{fig:org66c1174}) occurs due to the \hyperref[sec:org3567e2a]{photon decay} effect.
...
\label{sec:orgecc068b}
\subsection{Optimization of logical error rates}
\label{sec:orgcf292ee}

In Fig. \ref{fig:orgae2fd08} one can see that the optimal time for measuring is 280 ns.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.7\textwidth]{measure_t_optimization.png}
\caption{\label{fig:orgae2fd08}
...
\section{Doubts}
\label{sec:org7c80d14}
\begin{itemize}
\item What is the depletion time?
\item I do not understand the Inset in Fig. \ref{fig:orgae2fd08}
...
\item \sout{Is the \(p_{\phi, photon}\) summed to the \(p_{\phi}\) in the \(R_{\Lambda_{T_{\phi}}}\) or how is it done?} \(\to\) is the dephase at the beginning of the measurement model (Fig. \ref{fig:org66c1174})
