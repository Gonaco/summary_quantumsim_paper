...
\label{sec:org7c77324}

\begin{table}[htbp]
\caption{\label{tab:orge00c341}
...
The initial dephasing step in the measurement model (Fig. \ref{fig:orge2ce783}) occurs due to the \hyperref[sec:orgf77d28f]{photon decay} effect.
